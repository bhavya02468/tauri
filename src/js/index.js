...
function websdkready() {
  ...
  var SDK_KEY = "EGEGX2AAm64fXG6wIHrnqiXu8YFtEmU9WjWW";
  /**
   ...
   */
  var SDK_SECRET = "Cu2myPrl9RfvzrpyJSmYbHLF9UICVx2vnjNU";
  ...
  if (testTool.getCookie("meeting_lang"))
    document.getElementById("meeting_lang").value = "english"
  ...
  window.addEventListener('load', function (e) {
      ...
      var signature = ZoomMtg.generateSDKSignature({
        meetingNumber: localStorage.getItem("mn"),
        sdkKey: SDK_KEY,
        ...
        success: function (res) {
          ...
          localStorage.setItem("sdkKey",meetingConfig.sdkKey)
          localStorage.setItem("version",meetingConfig.version)
          localStorage.setItem("signature",meetingConfig.signature)
